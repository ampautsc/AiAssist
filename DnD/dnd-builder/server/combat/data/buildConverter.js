...
const { computeBuildStats, mod, proficiencyBonus } = require('../../utils/buildCalculator');
 ...
 * 
 * @param {Object} build — populated Mongoose lean document (species, feats, items)
 * @param {Object} [overrides] — optional overrides { id, name, position }
 * @returns {Object} creature ready for encounter runner
 */
function buildToCreature(build, overrides = {}) {
...
module.exports = { buildToCreature };
