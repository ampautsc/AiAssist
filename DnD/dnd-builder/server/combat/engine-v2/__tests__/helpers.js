/**
 * Shared test helpers for engine-v2 tests.
 *
 * Provides factory functions to create combat-ready creature objects
 * matching the shape used by the existing v1 engine and the new v2 GameState.
 */
 ...
 * Every property can be overridden.
 */
function makeCombatant(overrides = {}) {
  ...
  // Deep-copy aggregate fields so tests don't share references
...
/**
 * Create a Lore Bard with full spellcasting — the standard party member.
 */
...
module.exports = { makeCombatant, makeBard, makeEnemy, makeBrute }
