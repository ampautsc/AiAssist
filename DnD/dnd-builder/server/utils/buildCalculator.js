...
function computeBuildStats(build) {
  ...
  if (hasArmorProf) {
    ...
    if (hasBracers) {
      // Bracers of Defense require NO armor — intentionally unarmored
      finalAc = 10 + dexMod + 2;
    } else {
      // Bard has light armor proficiency → leather armor (AC 11 + DEX)
      finalAc = 11 + dexMod;
    }
  }
...
module.exports = { computeBuildStats, mod, proficiencyBonus };
