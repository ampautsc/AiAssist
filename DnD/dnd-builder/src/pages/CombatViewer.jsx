...
import CombatHexCanvas from "../components/CombatHexCanvas"
import CombatHud from "../components/hud/CombatHud"
import EncounterModal from "../components/hud/EncounterModal"
import DiceRollBar from "../components/hud/DiceRollBar"
...
export default function CombatViewer() {
   ...
   *
   * @param {import('../combat/encounters.js').Encounter} encounter
  ...
  return (
    <div data-testid="combat-viewer" data-session-id={combat.sessionId || ''}>
