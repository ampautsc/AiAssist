...
See `sis-core.instructions.md` Rule #3: LEARN FROM EVERYTHING.
...
**Search the Skills & Knowledge Index** in `sis-core.instructions.md` for matching tags.
...
Record in `Sis/History/YYYY-MM-DD.md`:
1. What was done
2. What worked
...
- Categories: `code`, `documentation`, `learning`, `problem-solving`, `communication`
- Use the template below
- Add it to the Skills & Knowledge Index in `sis-core.instructions.md` with tags
...
## Category
[code | documentation | learning | problem-solving | communication]
